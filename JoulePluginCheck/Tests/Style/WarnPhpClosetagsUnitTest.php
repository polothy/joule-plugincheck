...
/**
 * A unit test for the DisallowMultipleNamespaces Sniff
 *
 * @category  PHP
 * @package   JoulePluginCheck
 * @author    Corey Wallis <corey.wallis@blackboard.com>
 ...
 * @link      https://github.com/techxplorer/joule-plugincheck
 */
class JoulePluginCheck_Tests_Style_WarnPhpClosetagsUnitTest extends AbstractSniffUnitTest
{
    /**
    ...
    {
        /*
         * To Test the warnings, remove the whitespace and
         * uncomment out the below code.
         *
        return array(
            29 => 1
        );
